...
<div class="es-gallery js-es-property-gallery">
    <div class="es-gallery__image">
        ...
        <?php if ( ! empty( $images ) ) : ?>
        <a href="<?php echo es_get_the_featured_image_url( 'full', $property_id ); ?>" class="js-es-image" title="<?php echo esc_attr( wp_get_attachment_caption( $images[0] ) ); ?>">
        ...
        <div class="es-gallery__thumbs">
            <?php foreach ( $images as $attachment_id ) : $caption = wp_get_attachment_caption( $attachment_id );
                ...
                <div class="es-gallery__thumb">
                    ...
                    <?php endif; ?>
                    <a href="<?php echo wp_get_attachment_image_url( $attachment_id, 'full' ); ?>" class="js-es-image" title="<?php echo esc_attr( $caption ); ?>">
                ...
                <?php else : ?>
                    <a href="<?php echo wp_get_attachment_image_url( $attachment_id, 'full' ); ?>" title="<?php echo esc_attr( $caption ); ?>" class="js-es-image es-hidden"></a>
                <?php endif; ?>
