...
/**
* Class Elementor_Es_Single_Gallery_Widget.
*/
class Elementor_Es_Single_Property_Gallery_Widget extends Elementor_Es_Base_Widget  {
   ...
   public function get_name() {
     return 'es-single-property-gallery';
   }
   ...
   public function get_title() {
       return _x( 'Estatik Single Property Gallery', 'widget name', 'es' );
   }
    ...
    */
    protected function register_controls() {
        ...
        $shortcode = es_get_shortcode_instance( 'es_property_single_gallery' );
    ...
    */
    protected function render() {
        ...
        $shortcode = es_get_shortcode_instance( 'es_property_single_gallery', $settings );
