...
use VendorDuplicator\Google\Auth\Credentials\ExternalAccountCredentials;
use VendorDuplicator\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
