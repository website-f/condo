...
class HoursField extends AbstractField
{
    ...
    public function getPastTransition(DateTimeInterface $date): ?array
    {
        ...
        if ($this->transitions === null || $this->transitionsStart < $currentTimestamp + 86400 || $this->transitionsEnd > $currentTimestamp - 86400) {
            ...
            $this->transitions = $date->getTimezone()->getTransitions($dtLimitStart->getTimestamp(), $dtLimitEnd->getTimestamp());
