...
namespace FSPoster\App\SocialNetworks\TruthSocial\Adapters;

use FSPoster\App\Models\Channel;
use FSPoster\App\Providers\Channels\ChannelService;
use FSPoster\App\SocialNetworks\TruthSocial\Api\Api;
use FSPoster\App\SocialNetworks\TruthSocial\App\Bootstrap;
...
class ChannelAdapter
{
    ...
    {
	    return self::fetchChannelsFromAccountData( $api, $api->getMyInfo() );
    }

    public static function fetchChannelsFromAccountData ( Api $api, array $myInfo ): array
    {
