...
class Bootstrap extends SocialNetworkAddon
{
	...
	{
		Route::post( 'social-networks/flickr/settings', [ Controller::class, 'saveSettings' ] );
		Route::get( 'social-networks/flickr/settings', [ Controller::class, 'getSettings' ] );
		Route::post( 'social-networks/flickr/get-albums', [ Controller::class, 'getAlbums' ] );
