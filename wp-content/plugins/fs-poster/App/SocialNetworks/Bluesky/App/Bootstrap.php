...
{
    protected $slug = 'bluesky';
    protected $name = 'Bluesky';
    protected $icon = 'fab fa-bluesky';
    protected $sort = 210;

    public function init ()
    {
        Route::post( 'social-networks/bluesky/settings', [ Controller::class, 'saveSettings' ] );
        Route::get( 'social-networks/bluesky/settings', [ Controller::class, 'getSettings' ] );

        Route::post( 'social-networks/bluesky/channel-via-app-password', [ Controller::class, 'addChannelViaAppPassword' ] );
