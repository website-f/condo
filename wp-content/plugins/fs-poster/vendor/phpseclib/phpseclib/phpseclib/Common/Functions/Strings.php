 ...
 */
namespace FSPoster\phpseclib3\Common\Functions;

use FSPoster\ParagonIE\ConstantTime\Base64;
use FSPoster\ParagonIE\ConstantTime\Base64UrlSafe;
use FSPoster\ParagonIE\ConstantTime\Hex;
use FSPoster\phpseclib3\Math\BigInteger;
use FSPoster\phpseclib3\Math\Common\FiniteField;
/**
 * Common String Functions
 *
 * @author  Jim Wigginton <terrafrost@php.net>
