 ...
 */
namespace FSPoster\phpseclib3\File;

use FSPoster\phpseclib3\Common\Functions\Strings;
use FSPoster\phpseclib3\Crypt\Common\PrivateKey;
use FSPoster\phpseclib3\Crypt\Common\PublicKey;
use FSPoster\phpseclib3\Crypt\DSA;
use FSPoster\phpseclib3\Crypt\EC;
use FSPoster\phpseclib3\Crypt\Hash;
use FSPoster\phpseclib3\Crypt\PublicKeyLoader;
use FSPoster\phpseclib3\Crypt\Random;
use FSPoster\phpseclib3\Crypt\RSA;
use FSPoster\phpseclib3\Crypt\RSA\Formats\Keys\PSS;
use FSPoster\phpseclib3\Exception\UnsupportedAlgorithmException;
use FSPoster\phpseclib3\File\ASN1\Element;
...
class X509
{
    ...
    public function sign(X509 $issuer, X509 $subject)
    {
        ...
        if (isset($subject->domains) && \count($subject->domains)) {
            $altName = \array_map(['\\FSPoster\\phpseclib3\\File\\X509', 'dnsName'], $subject->domains);
        }
