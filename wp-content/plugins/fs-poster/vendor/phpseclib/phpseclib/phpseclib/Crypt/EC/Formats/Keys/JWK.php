 ...
 */
namespace FSPoster\phpseclib3\Crypt\EC\Formats\Keys;

use FSPoster\phpseclib3\Common\Functions\Strings;
use FSPoster\phpseclib3\Crypt\Common\Formats\Keys\JWK as Progenitor;
use FSPoster\phpseclib3\Crypt\EC\BaseCurves\Base as BaseCurve;
...
use FSPoster\phpseclib3\Crypt\EC\Curves\secp256k1;
use FSPoster\phpseclib3\Crypt\EC\Curves\secp256r1;
use FSPoster\phpseclib3\Crypt\EC\Curves\secp384r1;
use FSPoster\phpseclib3\Crypt\EC\Curves\secp521r1;
...
abstract class JWK extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $curve = '\\FSPoster\\phpseclib3\\Crypt\\EC\\Curves\\' . \str_replace('P-', 'nistp', $key->crv);
        $curve = new $curve();
