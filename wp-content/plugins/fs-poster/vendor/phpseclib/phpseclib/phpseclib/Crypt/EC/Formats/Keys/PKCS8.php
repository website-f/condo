...
use FSPoster\phpseclib3\Crypt\Common\Formats\Keys\PKCS8 as Progenitor;
...
use FSPoster\phpseclib3\File\ASN1\Maps;
...
abstract class PKCS8 extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if (!$params) {
            throw new \RuntimeException('FSPoster\\Unable to decode the parameters using Maps\\ECParameters');
        }
        $components = [];
