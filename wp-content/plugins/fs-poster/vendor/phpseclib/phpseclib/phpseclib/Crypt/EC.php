 ...
 */
namespace FSPoster\phpseclib3\Crypt;

use FSPoster\phpseclib3\Crypt\Common\AsymmetricKey;
use FSPoster\phpseclib3\Crypt\EC\BaseCurves\Montgomery as MontgomeryCurve;
use FSPoster\phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use FSPoster\phpseclib3\Crypt\EC\Curves\Curve25519;
use FSPoster\phpseclib3\Crypt\EC\Curves\Ed25519;
use FSPoster\phpseclib3\Crypt\EC\Curves\Ed448;
use FSPoster\phpseclib3\Crypt\EC\Formats\Keys\PKCS1;
use FSPoster\phpseclib3\Crypt\EC\Parameters;
use FSPoster\phpseclib3\Crypt\EC\PrivateKey;
use FSPoster\phpseclib3\Crypt\EC\PublicKey;
use FSPoster\phpseclib3\Exception\UnsupportedAlgorithmException;
use FSPoster\phpseclib3\Exception\UnsupportedCurveException;
use FSPoster\phpseclib3\Exception\UnsupportedOperationException;
use FSPoster\phpseclib3\File\ASN1;
use FSPoster\phpseclib3\File\ASN1\Maps\ECParameters;
use FSPoster\phpseclib3\Math\BigInteger;
/**
 * Pure-PHP implementation of EC.
 *
 * @author  Jim Wigginton <terrafrost@php.net>
...
abstract class EC extends AsymmetricKey
{
    ...
    public static function createKey($curve)
    {
        ...
        $curve = '\\FSPoster\\phpseclib3\\Crypt\\EC\\Curves\\' . $curveName;
