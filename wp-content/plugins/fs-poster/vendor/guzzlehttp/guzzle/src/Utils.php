...
use FSPoster\GuzzleHttp\Exception\InvalidArgumentException;
use FSPoster\GuzzleHttp\Handler\CurlHandler;
use FSPoster\GuzzleHttp\Handler\CurlMultiHandler;
use FSPoster\GuzzleHttp\Handler\Proxy;
use FSPoster\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \FSPoster\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    /**
