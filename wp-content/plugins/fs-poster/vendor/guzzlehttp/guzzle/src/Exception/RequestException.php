...
namespace FSPoster\GuzzleHttp\Exception;

use FSPoster\GuzzleHttp\BodySummarizer;
use FSPoster\GuzzleHttp\BodySummarizerInterface;
use FSPoster\Psr\Http\Client\RequestExceptionInterface;
