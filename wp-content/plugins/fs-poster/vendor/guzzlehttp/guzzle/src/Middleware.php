...
namespace FSPoster\GuzzleHttp;

use FSPoster\GuzzleHttp\Cookie\CookieJarInterface;
...
use FSPoster\Psr\Log\LoggerInterface;
/**
        ...
        return static function (callable $handler) : callable {
            return static function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('FSPoster\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
