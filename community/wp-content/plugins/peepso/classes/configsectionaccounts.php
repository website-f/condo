...
class PeepSoConfigSectionAccounts extends PeepSoConfigSectionAbstract {
    ...
    private function inactive_users() {
        ...
        $this->args( 'descript',
            __( 'ON: Remove inactive users from the community.', 'peepso-core' )
            . "<br/>"
            . __( 'Applies to all users.', 'peepso-core' )
        );
        $this->set_field(
            'remove_inactive_users',
            __('Remove inactive users', 'peepso-core'),
            'yesno_switch',
        );

        $this->args('default', 30);
        $this->args('validation', ['numeric'] );

        $this->set_field(
            'remove_inactive_users_period',
            __('Remove inactive users after: [n] days', 'peepso-core'),
            'text'
        );
        ...
        $this->set_field(
            'disable_remove_inactive_users_cron',
    ...
    private function security() {
	    ...
	    $this->set_field(
		    ...
		    __('Password strength requirements', 'peepso-core'),
		    'separator'
	    );

	    $this->set_field(
		    'msg_password_reset',
		    __('These rules apply only to new passwords', 'peepso-core'),
		    'message'
	    );
        ...
        for($i=5;$i<=20;$i+=1) {
            $options[$i]=$i . ' ' . __('characters long','peepso-core');
        }
		...
		$options = array(
			0 => sprintf(_n('%s lowercase character', '%s lowercase characters', 0, 'peepso-core'), '0'),
			1 => sprintf(_n('%s lowercase character', '%s lowercase characters', 1, 'peepso-core'), '1'),
			2 => sprintf(_n('%s lowercase character', '%s lowercase characters', 2, 'peepso-core'), '2'),
			3 => sprintf(_n('%s lowercase character', '%s lowercase characters', 3, 'peepso-core'), '3'),
			4 => sprintf(_n('%s lowercase character', '%s lowercase characters', 4, 'peepso-core'), '4'),
			5 => sprintf(_n('%s lowercase character', '%s lowercase characters', 5, 'peepso-core'), '5'),
		);
	    $this->args('options', $options);
	    $this->set_field(
		...
		$options = array(
			0 => sprintf(_n('%s uppercase character', '%s uppercase characters', 0, 'peepso-core'), '0'),
			1 => sprintf(_n('%s uppercase character', '%s uppercase characters', 1, 'peepso-core'), '1'),
			2 => sprintf(_n('%s uppercase character', '%s uppercase characters', 2, 'peepso-core'), '2'),
			3 => sprintf(_n('%s uppercase character', '%s uppercase characters', 3, 'peepso-core'), '3'),
			4 => sprintf(_n('%s uppercase character', '%s uppercase characters', 4, 'peepso-core'), '4'),
			5 => sprintf(_n('%s uppercase character', '%s uppercase characters', 5, 'peepso-core'), '5'),
		);
		$this->args('options', $options);
		$this->set_field(
		...
		$options = array(
			0 => sprintf(_n('%s number', '%s numbers', 0, 'peepso-core'), '0'),
			1 => sprintf(_n('%s number', '%s numbers', 1, 'peepso-core'), '1'),
			2 => sprintf(_n('%s number', '%s numbers', 2, 'peepso-core'), '2'),
			3 => sprintf(_n('%s number', '%s numbers', 3, 'peepso-core'), '3'),
			4 => sprintf(_n('%s number', '%s numbers', 4, 'peepso-core'), '4'),
			5 => sprintf(_n('%s number', '%s numbers', 5, 'peepso-core'), '5'),
		);
		$this->args('options', $options);
		$this->set_field(
		    'password_strength_number',
			__('Minimum', 'peepso-core'),
		    'select'
	    );

		$options = array(
			0 => sprintf(_n('%s special character', '%s special characters', 0, 'peepso-core'), '0'),
			1 => sprintf(_n('%s special character', '%s special characters', 1, 'peepso-core'), '1'),
			2 => sprintf(_n('%s special character', '%s special characters', 2, 'peepso-core'), '2'),
			3 => sprintf(_n('%s special character', '%s special characters', 3, 'peepso-core'), '3'),
			4 => sprintf(_n('%s special character', '%s special characters', 4, 'peepso-core'), '4'),
			5 => sprintf(_n('%s special character', '%s special characters', 5, 'peepso-core'), '5'),
		);
		$this->args('options', $options);
		$this->set_field(
	    ...
	    // Reset delay
	    $this->set_field(
		    'password_reset_separator',
		    __('Password reset', 'peepso-core'),
		    'separator'
	    );
        $options=array();
        ...
        $this->args('default', 1);
        $this->set_field(
            'ajax_callback_nonce_enable',
            __('Ajax callback nonce check', 'peepso-core'),
            'yesno_switch'
        );
    ...
    private function registration() {
        ...
        $this->args( 'descript', __( 'ON: no password fields on registration, random password will be sent through email.', 'peepso-core' ) );

        $this->set_field(
            'site_registration_hide_password',
            __( 'Hide password fields', 'peepso-core' ),
            'yesno_switch'
        );
