		...
		<div class="ps-followers">
			...
			<?php
				if (get_current_user_id()) {
					...
					?>
					<div class="pso-members pso-members--grid pso-members--followers ps-js-followers ps-js-followers--<?php echo apply_filters('peepso_user_profile_id', 0); ?>"></div>
					<div class="pso-members__loading ps-js-followers-triggerscroll ps-js-followers-triggerscroll--<?php echo apply_filters('peepso_user_profile_id', 0); ?>">
