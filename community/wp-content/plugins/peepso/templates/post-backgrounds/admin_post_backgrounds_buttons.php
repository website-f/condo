<div class="ps-settings__bar clearfix ps-settings__bar--static">
	<div class="ps-settings__nav">
		<button type="button" class="ps-js-post-backgrounds-expand-all">
			<i class="fa fa-expand"></i> <span><?php echo esc_attr__('Expand All', 'peepso-core'); ?></span>
		</button>
		<button type="button" class="ps-js-post-backgrounds-collapse-all">
	...
	<div class="ps-settings__nav ps-settings__nav--right ps-dropdown">
		<button type="button" class="btn-primary ps-js-post-backgrounds-new">
