<div class="notice notice-warning peepso ps-notice">
    ...
    <h1>Welcome to PeepSo <?php echo PeepSo::PLUGIN_VERSION;?></h1>
    ...
    <?php if(!PeepSo3_Helper_Addons::get_license()) { ?>
        <p><i class="gci gci-gift"></i> Get the most out of PeepSo: start with the <a href="<?php echo admin_url('admin.php?page=peepso-installer&action=peepso-free');?>"><b>PeepSo Free Bundle</b></a> or check out our <a href="https://peepso.com/pricing/ref/429" target="_blank"><b>full pricing</b></a>.</p>
        <p></p>
    <?php } ?>
