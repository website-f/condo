<div class="notice notice-warning peepso">
	<p>
	<?php echo sprintf(__('Thank you for upgrading PeepSo to the latest version. Please consider leaving us a <a href="%s" aria-label="Leave us a review!">★★★★★ review.</a> Thank you in advance!', 'peepso-core'), 'https://www.trustpilot.com/review/peepso.com'); ?>
    </p>
    <p>
