...
<div class="error peepso">
    ...
    echo sprintf( wp_kses_post( __( '<b>PeepSo</b> requires %s (%s or newer) to be %sinstalled%s and %sactivated%s to run <b>PeepSo %s</b>', 'peepso-core')), $install_link_1, $ver_min, $install_link_2,'</a>',$install_link_3,'</a>',$peepso_name );?>
</div>
