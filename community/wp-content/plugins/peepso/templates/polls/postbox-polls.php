		...
		<div class="ps-postbox__poll-container">
			<div class="ps-postbox__poll-options ui-sortable">
				<div class="ps-postbox__poll-option ps-poll__option">
					<a class="ps-btn ps-btn--sm ps-btn--app ps-btn--cp ps-js-handle ui-sortable-handle" title="<?php echo esc_attr__('Move', 'peepso-core'); ?>" href="#"><i class="gcis gci-arrows-alt"></i></a>
					<input class="ps-input ps-input--sm" type="text" placeholder="<?php echo esc_attr__('Option 1', 'peepso-core'); ?>">
					<a id="ps-delete-option" class="ps-btn ps-btn--sm ps-btn--cp ps-btn--delete ps-tip ps-tip--arrow" aria-label="<?php echo esc_attr__('Delete', 'peepso-core'); ?>" href="#"><i class="gcis gci-trash"></i></a>
				</div>
				<div class="ps-postbox__poll-option ps-poll__option">
					<a class="ps-btn ps-btn--sm ps-btn--app ps-btn--cp ps-js-handle ui-sortable-handle" title="<?php echo esc_attr__('Move', 'peepso-core'); ?>" href="#"><i class="gcis gci-arrows-alt"></i></a>
			...
			<div class="ps-postbox__poll-actions">
				<button class="ps-btn ps-btn--action ps-btn--sm ps-button-action" id="ps-add-new-option"><?php echo esc_attr__('Add new option', 'peepso-core');?></button>
				...
				<?php if (isset($multiselect) && $multiselect) : ?>
					<div class="ps-checkbox">
						...
						<label class="ps-checkbox__label lbl" for="allow-multiple"><?php echo esc_attr__('Allow multiple options selection', 'peepso-core'); ?></label>
					</div>
				<?php endif; ?>
			</div>
		</div>
