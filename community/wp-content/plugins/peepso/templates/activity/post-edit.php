	...
	<div class="ps-postbox__inner">
			...
			<div class="ps-postbox__status ps-postbox-status">
				<div class="ps-postbox__status-wrapper">
					<div class="ps-postbox__input-wrapper ps-postbox-input ps-inputbox">
						...
						<textarea class="ps-postbox__input ps-textarea ps-postbox-textarea" placeholder="<?php echo esc_attr__(apply_filters('peepso_postbox_message', 'Say what is on your mind...'), 'peepso-core'); ?>"><?php echo $cont; ?></textarea>
		...
		<div class="ps-postbox__footer ps-postbox-tab selected">
			...
			<div class="ps-postbox__actions ps-postbox-action">
				<button type="button" class="ps-btn ps-btn--sm ps-postbox__action ps-postbox__action--cancel ps-button-cancel" onclick="return activity.option_canceledit(<?php echo $act_id; ?>);"><?php echo esc_attr__('Cancel', 'peepso-core'); ?></button>
				<button type="button" class="ps-btn ps-btn--sm ps-btn--action ps-postbox__action ps-postbox__action--post ps-button-action postbox-submit" onclick="return activity.option_savepost(<?php echo $act_id; ?>);"><?php echo esc_attr__('Post', 'peepso-core'); ?></button>
			</div>
