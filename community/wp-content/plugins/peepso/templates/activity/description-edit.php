	...
	<div class="ps-postbox__inner">
		...
		<div class="ps-postbox__footer ps-postbox-tab selected">
			...
			<div class="ps-postbox__actions ps-postbox-action">
				<button class="ps-btn ps-btn--sm ps-postbox__action ps-postbox__action--cancel ps-button-cancel" onclick="return activity.option_cancel_edit_description('<?php echo $act_id; ?>');"><?php echo esc_attr__('Cancel', 'peepso-core'); ?></button>
				<button class="ps-btn ps-btn--sm ps-btn--action ps-postbox__action ps-postbox__action--post ps-button-action" onclick="return activity.option_save_description('<?php echo $act_id; ?>', '<?php echo $type; ?>', '<?php echo $act_external_id; ?>');"><?php echo esc_attr__('Save', 'peepso-core'); ?></button>
			</div>
